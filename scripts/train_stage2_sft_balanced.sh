...
CSV_PATH="$PKG_ROOT/dataset/splits/kepco_group_balanced_train_test.csv"
STAGE1_CKPT="${1:-$PKG_ROOT/engine/runs/stage1_vitb_cla_balanced/vit_base_patch16_clip_224.laion2b_final.pth}"
OUT_DIR="$PKG_ROOT/engine/runs/stage2_vitb_cla_sft_balanced"
